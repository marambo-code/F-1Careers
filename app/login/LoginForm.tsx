  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 border border-border rounded-xl py-3 text-sm font-semibold text-navy hover:bg-gray-50 transition-colors disabled:opacity-60"
      >
      ...
      <div className="pt-4 border-t border-border text-center space-y-2">
        ...
        <Link href="/forgot-password" className="text-xs text-mid hover:text-navy transition-colors block">
